...
var BLHELI_LAYOUT = {
    ...
    _P_GAIN:                    {   offset: 0x03, size: 1   },
    STARTUP_BOOST:              {   offset: 0x04, size: 1   }, // TODO: not final
    STARTUP_BEEP:               {   offset: 0x05, size: 1   },
    DITHERING:                  {   offset: 0x06, size: 1   },
    _MOTOR_GAIN:                {   offset: 0x07, size: 1   },
    _MOTOR_IDLE:                {   offset: 0x08, size: 1   },
    STARTUP_POWER:              {   offset: 0x09, size: 1   },
    _PWM_FREQUENCY:             {   offset: 0x0A, size: 1   },
    MOTOR_DIRECTION:            {   offset: 0x0B, size: 1   },
    _INPUT_PWM_POLARITY:        {   offset: 0x0C, size: 1   },
    MODE:                       {   offset: 0x0D, size: 2   },

    _PROGRAMMING_BY_TX:         {   offset: 0x0F, size: 1   },
    _REARM_AT_START:            {   offset: 0x10, size: 1   },
    _GOVERNOR_SETUP_TARGET:     {   offset: 0x11, size: 1   },
    _STARTUP_RPM:               {   offset: 0x12, size: 1   },
    _STARTUP_ACCELERATION:      {   offset: 0x13, size: 1   },
    _VOLT_COMP:                 {   offset: 0x14, size: 1   },
    COMMUTATION_TIMING:         {   offset: 0x15, size: 1   },
    _DAMPING_FORCE:             {   offset: 0x16, size: 1   },
    _GOVERNOR_RANGE:            {   offset: 0x17, size: 1   },
    _STARTUP_METHOD:            {   offset: 0x18, size: 1   },
